...
define gui.accent_color = '#d7bd7c'

## The color used for a text button when it is neither selected nor hovered.
define gui.idle_color = '#b39b66'

## The small color is used for small text, which needs to be brighter/darker to
## achieve the same effect.
define gui.idle_small_color = '#c7b080'

## The color that is used for buttons and bars that are hovered.
define gui.hover_color = '#e7cf93'

## The color used for a text button when it is selected but not focused. A
## button is selected if it is the current screen or preference value.
define gui.selected_color = '#d7bd7c'

## The color used for a text button when it cannot be selected.
define gui.insensitive_color = '#b39b667f'

## Colors used for the portions of bars that are not filled in. These are not
## used directly, but are used when re-generating bar image files.
define gui.muted_color = '#6b5a34'
define gui.hover_muted_color = '#8a7546'

## Barra separadora entre navegação e conteúdo no game menu.
define gui.game_menu_separator_color = '#d7bd7c'
define gui.game_menu_separator_xpos = 420
define gui.game_menu_separator_width = 4
...
## The font used for out-of-game text (menus/interface).
