...
## In-game dialogue screens moved to:
## - game/screens/dialogue_screens.rpy


## Main/game menu screens moved to:
## - game/screens/menu_screens.rpy
...
screen confirm(message, yes_action, no_action):
    ...
    ## Borda na cor do tema (gui.accent_color): o verde vinha do 9-patch gui/frame.png.
    frame:
        style "confirm_frame_outer"
        frame:
            style "confirm_frame"
            vbox:
                xalign .5
...
style confirm_frame_outer is gui_frame
